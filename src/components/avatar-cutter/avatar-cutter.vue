    ...
    <div class="container g-popup-box">
      ...
      <div class="content">
        <div class="c-left" :class="{ 'c-left--doing': imgURL }">
          ...
          >
            ...
            >
              ...
              <ul class="point">
                <li
                  @mousedown.stop="onMouseDown($event, 'stretch', 'top-left')"
                ></li>
                <li
                  @mousedown.stop="onMouseDown($event, 'stretch', 'top-right')"
                ></li>
                <li
                  @mousedown.stop="
        ...
        <div class="c-right">
          ...
          <div class="btn-upload">{{ !imgURL ? "上传图片" : "重新上传" }}</div>
...
export default {
  ...
  created() {
    // this.getBase64Image(this.imgSrc, "$img");
