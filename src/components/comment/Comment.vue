  ...
  <div class="hbl-fa">
      ...
      <div class="comment" :style="{width:commentWidth}">
        ...
        <div v-if="buttonMap[0]" class="hbl-owo">
          ...
          <div class="publish publish-btn">
            <button class="btn" @click="doSend(),cancel(0)">发送</button>
    ...
    <div class="comm">
      ...
      <div class="com-rep com-title">
        评论
        <span class="com-span">({{this.commentList.length}})</span>
      </div>
    </div>
        ...
        <div class="reply-content reply-fa">
          ...
          >
            ...
            <div v-if="buttonMap[item.id]" class="hbl-owo">
              ...
              <div class="publish publish-btn">
                <button class="btn" @click="doChidSend(item.id,item.commentUser.id,item.id),cancel(item.id)">发送</button>
          ...
          <div class="reply-content reply-fa">
            ...
            >
              ...
              <div v-if="buttonMap[ritem.id]" class="hbl-owo">
                ...
                <div class="publish publish-btn">
                  <button class="btn" @click="doChidSend(ritem.id,ritem.commentUser.id,item.id),cancel(ritem.id)">发送</button>
